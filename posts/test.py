...
# response=requests.get(BASE+"user/User-f8f190a0-8683-11ec-8657-1e00310cd078",allow_redirects=True,headers=headers)
# print(response.json())

# response=requests.put(BASE+"/user/User-f8f190a0-8683-11ec-8657-1e00310cd078",json={"email":"kiran_attal@scmhrd.edu","last_name":"Attal","tags":["life","learning","swag"]})
# print(response.json())
...
response=requests.post(BASE+"/post",files=files, data={"created_by":"U123456"})
print(response.json())
